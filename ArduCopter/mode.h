...
public:
    ...
    enum class Number : uint8_t {
        ...
        CUSTOM =       29,  //Custom mode example for Naviator project
    };
    ...
    virtual bool in_custom_mode() const { return false; }
...
// This is just a copy of GuidedMode to showcase how a new mode would be implemented
...
public:
    ...
    bool is_autopilot() const override { return true; }
    bool has_user_takeoff(bool must_navigate) const override { return true; }
    bool in_custom_mode() const override { return true; }
